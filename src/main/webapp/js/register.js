...
$('#download').on('click', function (e) {
    if (browser.userAgent.ios && !browser.userAgent.weiXin) {
      //  var loadDateTime = new Date();

        //alert("ios设备")
       // window.location.href = 'https://itunes.apple.com/cn/app/id1486128877';
       window.location.href = 'scheme://appraisal/detail?id=' + getQueryString("appraisalId") +'&from=web';
        setTimeout(function(){
            //alert("打开APP store")
            window.location.href = 'https://itunes.apple.com/cn/app/id1486128877';
        },2000);
        ...
        setTimeout(function(){
           // alert("下载apk安装包")
            window.location.href="https://appraisal.oss-cn-beijing.aliyuncs.com/1571301214422.jpg";
            $.ajax({
