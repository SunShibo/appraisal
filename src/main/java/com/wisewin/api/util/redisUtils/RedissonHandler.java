...
public class RedissonHandler {
    ...
    private final String ip = "47.95.113.129";//"r-2zec622a372f0b04.redis.rds.aliyuncs.com"; "wisewin-tech.com" //zccxywy.cn  47.95.113.129

    private final String password = "Jianding1!";//wangyang
